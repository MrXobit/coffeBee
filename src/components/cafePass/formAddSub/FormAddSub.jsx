  ...
  const handleEddNewSub = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://us-central1-coffee-bee.cloudfunctions.net/subscriptionsCreate',
        {
          title,          
          duration,      
  ...
  return (
    <div className="form-add-new-sub-container">
      ...
      <form className="form-add-new-sub-form" onSubmit={handleEddNewSub}>
        ...
        <button type="submit" disabled={loading} className="form-add-new-sub-submit-btn">{loading ? 'Loading...' : 'Submit'}</button>
      </form>
    </div>
  );
};
